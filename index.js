...
function render() {
    ...
    let renderPlayer = document.getElementById("RenderPlayer");
    let temp1 = "";
    players.getData().map((item) => {
        temp1 += `
    <div class="body-item">
...
function playerLength() {
    let playerLength1 = document.getElementById("playerLength");
    let playerLength2 = document.getElementById("totalPoint");
...
playerLength();
function getLocal1() {
    let getDataLocal = JSON.parse(localStorage.getItem("Player1"));
    if (getDataLocal) {
